...
class GameOver extends Phaser.Scene{
    ...
    preload(){
		...
		this.load.audio('mderrota', '../public/resources/audio/stones.mp3');
		this.load.image('espacio2', '../public/resources/img/espacio.jpg');
		this.load.image('espacio1', '../public/resources/img/cielo.jpg');
		this.load.image('restos1', '../public/resources/img/restos2.png');
		this.load.image('restos2', '../public/resources/img/restos1.png');
		this.load.image('restos3', '../public/resources/img/restos3.png');
